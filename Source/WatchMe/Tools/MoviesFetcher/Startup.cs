namespace MoviesFetcher
{
    ...
    public class Startup
    {
        ...
        {
            const string ImdbTitleUrl = "http://www.imdb.com/title/";
            const string BaseImageUrl = "https://image.tmdb.org/t/p/w185";

            var db = new WatchMeDbContext();
            TMDbClient client = new TMDbClient("33551b01424882b74730e2ee86ca1693");
